...
// Task 4
void result(double x) { cout << "The power is: " << x << endl; }
...
// Task 5
void resultx(int sum) { cout << "The sum of array elements is: " << sum << endl; }
void sumx(int array[]) {
	int sum = 0;
	for (int i = 0; i < 5; i++) {
		sum += array[i];
...
void cube() { cubex = number * number * number; }
void write() {
...
void processInfo() { readAndDisplay(); }
